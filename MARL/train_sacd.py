...
if __name__ == "__main__":
    ...
    env = make_vec_env('merge-single-agent', n_envs=1, vec_env_cls=SubprocVecEnv, env_kwargs={"config": config})
    ...
    model = SACD('MlpPolicy', env,
                  ...
                  gamma=0.99,
                  verbose=1,
                  tensorboard_log="./sacd_log",
                  device='cpu')
    model.learn(int(5e5))
    model.save("model_sacd_direct_traffic_3_nenv_1.zip")
