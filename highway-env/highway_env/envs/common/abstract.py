...
def get_reward(obs, action):
   ...
   for i in range(num_obs):
       ...
       vehicle_x_pos = obs[i, 1]
       vehicle_y_pos = obs[i, 2]
       vehicle_speed = obs[i, 3]

       vehicle_x_speed = obs[i, 3]
       vehicle_y_speed = obs[i, 4]
       ...
       for j in range(4):
           vx = obs[i, (j+1)*5+1] + vehicle_x_pos
           vy = obs[i, (j+1)*5+2] + vehicle_y_pos
